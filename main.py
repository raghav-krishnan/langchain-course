...
information =  """
Elon Reeve Musk (/ˈiːlɒn/ EE-lon; born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, Twitter, and xAI. Musk has been the wealthiest person in the world since 2021; as of January 2026, Forbes estimates his net worth to be around US$785 billion.
...
llm = ChatOllama(model="gemma3:270m", temperature=0)# prompt template 
